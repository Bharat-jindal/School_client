...
class EditProperties extends Component {
    ...
    onUpdateTeacher=()=>{
        ...
        this.props.onUpdateTeacherRequest(
            this.props._id,
    ...
    render(){
        ...
        for(let key in this.state.fields){
            ...
            let form=(
                ...
                Admin:
                <select value={this.state.admin} onChange={this.onselectHandler}>
...
const mapStateToProps = state => {
  ...
  const mapDispatchToProps = dispatch => {
    return {
      onUpdateTeacherRequest:(_id,name,streat,town,district,state,admin)=>dispatch(actions.updateTeacher(_id,name,streat,town,district,state,admin))
    }
  }
